...
contract NFTMarketPlace is ReentrancyGuard, RoyaltiesV2Impl {
    ...
    struct NftMerketItem{
        ...
        uint256 price;
    //   uint256 royaltyInfo(_tokenId, _salePrice);;
        bool sold;
...
///////////////////////////////////
    ...
    //    require(royalties >0, "The royalty should be more that 0");
        itemId.increment();
...
function setRoyalties(uint _tokenId, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints) public nonReentrant {
...
function supportsInterface(bytes4 interfaceId) public view returns (bool) {
    ...
    return NFTMarketPlace.supportsInterface(interfaceId);
} 
...
/////////////////////////////////////////
   ...
   //  uint256 royalties = idForMarketItem[nftItemId].royalties;
